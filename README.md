...
The report will be structured in three parts: **Section 2 - Material and Methods** where we describe the tools and techniques used to solve the problem, **Section 3 - Results**, where we present the results obtained, and **Section 4 - Discussion**, where we discuss the relevance of our solution, point the limitations, and discuss possible future work.
